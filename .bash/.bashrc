...
# Claude Code
alias cpcld="cp ~/Home/Development/personal/CLAUDE.md ~/dev-configs/lib/claude/CLAUDE.md"
...
alias clno="bash ~/dev-configs/scripts/clone_oss_repos.sh"
alias clnp="bash ~/dev-configs/scripts/clone_personal_repos.sh"
