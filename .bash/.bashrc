...
if command -v git &> /dev/null; then
  default_branch=$(git rev-parse --abbrev-ref origin/HEAD 2>/dev/null | cut -f2- -d/)
  default_remote_branch=$(git rev-parse --abbrev-ref origin/HEAD 2>/dev/null)
...
alias fudp="bash ~/dev-configs/scripts/flush_and_update_personal_repos.sh"
alias fudo="bash ~/dev-configs/scripts/flush_and_update_oss_repos.sh"
alias fuda="
  bash ~/dev-configs/scripts/flush_and_update_personal_repos.sh &&
  bash ~/dev-configs/scripts/flush_and_update_oss_repos.sh
"
alias udpd="bash ~/dev-configs/scripts/update_package_dependencies.sh"
...
## rbenv
alias resup="git clone git@github.com:rbenv/rbenv.git ~/.rbenv && cd ~/.rbenv/plugins/ruby-build && git clone git@github.com:rbenv/ruby-build.git . && cd -"
alias reist="rbenv install"
alias reistls="rbenv install --list"
alias reuist="rbenv uninstall"
alias revers="rbenv versions"
alias relcl="rbenv local"
alias reglb="rbenv global"
...
## pyenv
alias pesup="git clone git@github.com:pyenv/pyenv.git ~/.pyenv && cd ~/.pyenv/plugins/python-build && bash install.sh && cd -"
alias peist="pyenv install"
alias peistls="pyenv install --list"
alias peuist="pyenv uninstall"
alias pevers="pyenv versions"
alias pelcl="pyenv local"
alias peglb="pyenv global"
...
## ndenv
alias nesup="git clone git@github.com:riywo/ndenv.git ~/.ndenv && cd ~/.ndenv/plugins/node-build && git clone git@github.com:riywo/node-build.git . && cd -"
alias neist="ndenv install"
alias neistls="ndenv install --list"
alias neuist="ndenv uninstall"
alias nevers="ndenv versions"
alias nelcl="ndenv local"
alias neglb="ndenv global"
...
# Webdriver
alias dlwd="
  wget https://storage.googleapis.com/chrome-for-testing-public/149.0.7827.55/linux64/chromedriver-linux64.zip -P ~/Home/Development/personal/web-scrapers/webdrivers &&
